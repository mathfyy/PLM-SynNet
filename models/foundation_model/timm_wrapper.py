...
class TimmCNNEncoder(torch.nn.Module):
    def __init__(self, model_name: str = 'resnet50.tv_in1k',
        ...
        self.model = timm.create_model(model_name, pretrained_cfg_overlay=dict(
        file="/data1/dataset/gbm_data/pipeline_data_usecaptk/fengyy/BrainTumorPath/pretrain_model/resnet50.tv_in1k/pytorch_model.bin"), **kwargs)
