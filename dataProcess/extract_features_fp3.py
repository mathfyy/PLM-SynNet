...
parser.add_argument('--feat_dir', type=str, default='/data1/dataset/gbm_data/pipeline_data_usecaptk/fengyy/BrainTumorPath/PCA-EPE/patch_feature_Virchow2/')
parser.add_argument('--is_svd', type=str, default= False)
parser.add_argument('--slide_ext', type=str, default= '.svs')
parser.add_argument('--model_name', type=str, default='Virchow2', choices=['resnet50_trunc', 'uni_v1', 'Virchow', 'Virchow2', 'H-optimus-0', 'prov-gigapath', 'uni2-h', 'conch_v1', 'conch_v1_5', 'CHIEF-Ctranspath', 'MUSK'])
# resnet50-1024
# uni-1024
# Virchow-2560
# Virchow2-2560
