...
from models.foundation_model.builder import get_encoder
...
parser.add_argument('--feat_dir', type=str, default='/data1/dataset/gbm_data/pipeline_data_usecaptk/fengyy/BrainTumorPath/PCA-EPE/patch_feature_uni2/')
parser.add_argument('--is_svd', type=str, default= False)
parser.add_argument('--slide_ext', type=str, default= '.svs')
parser.add_argument('--model_name', type=str, default='uni2-h', choices=['resnet50_trunc', 'uni_v1', 'uni2-h', 'conch_v1', 'conch_v1_5', 'CHIEF-Ctranspath', 'MUSK'])
# resnet50-1024
# uni-1024
# uni2-1536
# conch-512
